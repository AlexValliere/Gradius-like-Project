...
/*   Updated: 2015/01/10 16:27:07 by alex             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
EnnemyShip::EnnemyShip(void) : _id(EnnemyShip::_index), _x(0), _y(0) {
...
EnnemyShip::EnnemyShip(int x, int y) : _id(EnnemyShip::_index), _x(x), _y(y) {
	if (DebugEntity::getDebug() == true)
		std::cout << "EnnemyShip #" << this->_id << " created at x=" << this->_x << "; y=" << this->_y << "." << std::endl;
